...
// create page menu
$side_menu  = '';
$side_menu .= pageMenu('admin/setting_dashboard.php', 'tachometer', $lang['dashboard'], 80);
...
$side_menu .= pageMenuNotify('admin/setting_contact.php', 'life-saver', $lang['manage_contact'], 'contact_notify', $setting['can_mcontact']);
$side_menu .= pageMenu('admin/setting_modules.php', 'cubes', $lang['manage_module'], 100);
...
// menu drop 3
	$drop3 	= pageDropItem('admin/setting_info.php', $lang['system_status'], 100);
	$drop3 .= pageDropItem('admin/setting_update.php', $lang['system_update'], 100);
$side_menu .= pageDropMenu('wrench', $lang['system_tools'], $drop3, min($setting['can_mlogs'], 100));


	$drop4  = pageDropItem('admin/setting_gold.php', $lang['gold_settings'], 100);
	$drop4 .= pageDropItem('admin/setting_gift.php', $lang['gift_settings'], 100);
$side_menu .= pageDropMenu('database', $lang['gold_system'], $drop4, min(100, 100));
