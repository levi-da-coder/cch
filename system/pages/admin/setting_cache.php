	...
	<div class="page_element">
		<div class="form_content">
			<div class="setting_element ">
				<p class="label"><?php echo $lang['redis_status']; ?></p>
		...
		<div class="form_control">
			<button onclick="saveAdminCache();" type="button" class="reg_button theme_btn "><i class="fa fa-floppy-o"></i> <?php echo $lang['save']; ?></button>
