	...
	<div id="main_tab">
		<div id="main_zone" class="tab_zone">
			<div class="page_element">
				...
				<div class="form_control">
					<button onclick="saveAdminMain();" type="button" class="reg_button theme_btn"><i class="fa fa-floppy-o"></i> <?php echo $lang['save']; ?></button>
				</div>
			</div>
		</div>
		<div id="maint_zone" class="tab_zone hide_zone">
			<div class="page_element">
				...
				<div class="form_control">
					<button onclick="saveAdminMaintenance();" type="button" class="reg_button theme_btn"><i class="fa fa-floppy-o"></i> <?php echo $lang['save']; ?></button>
				</div>
			</div>
		</div>
	</div>
