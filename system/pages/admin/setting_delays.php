...
<div class="page_full">
	<div class="page_element">
		<div class="form_content">
			...
			<div class="setting_element ">
				...
				<select id="set_member_delete">
					<option value="0"><?php echo $lang['never']; ?></option>
					<?php echo optionMinutes($setting['member_delete'], array(10080,20160,43200,86400,129600,525600)); ?>
				</select>
			</div>
			<div class="setting_element ">
		...
		<div class="form_control">
			<button onclick="saveAdminDelays();" type="button" class="reg_button theme_btn"><i class="fa fa-floppy-o"></i> <?php echo $lang['save']; ?></button>
		</div>
	</div>
</div>