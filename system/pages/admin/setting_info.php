	...
	<div class="page_element">
		<div class="listing_reg blisting system_item">
			<div class="listing_reg_content">
				<i class="fa fa-file-o"></i> system / settings.php
			</div>
		...
		<div class="listing_reg blisting system_item">
			<div class="listing_reg_content">
				<i class="fa fa-folder-open-o"></i> avatar folder
			</div>
			<div class="listing_reg_icon">
		...
		<div class="listing_reg blisting system_item">
			<div class="listing_reg_content">
				<i class="fa fa-folder-open-o"></i> cover folder
			</div>
			<div class="listing_reg_icon">
		...
		<div class="listing_reg blisting system_item">
			<div class="listing_reg_content">
				<i class="fa fa-folder-open-o"></i> upload folder
			</div>
			<div class="listing_reg_icon">
		...
		<div class="listing_reg blisting system_item">
			<div class="listing_reg_content">
				<i class="fa fa-folder-open-o"></i> gift folder
			</div>
			<div class="listing_reg_icon">
				<?php echo $check_gift; ?>
			</div>
