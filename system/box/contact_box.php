...
<div class="modal_control">
	<button onclick="replyContact(<?php echo $contact['id']; ?>);" class="reg_button theme_btn"><i class="fa fa-send"></i> <?php echo $lang['reply']; ?></button>
	<button class="reg_button default_btn cancel_modal"><?php echo $lang['cancel']; ?></button>
	<button onclick="deleteContact(<?php echo $contact['id']; ?>);" class="button fright rtl_fleft delete_btn"><i class="fa fa-trash"></i></button>
</div>