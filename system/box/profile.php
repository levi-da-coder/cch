...
$about = userDataDetails($user, 'user_about');
?>
...
<div id="mprofilemenu">
	<div class="modal_zone pad25 tpad15" id="probio">
		<div class="tpad10">
			...
			<div class="btable blisting proitem">
				<div class="bcell_mid bold"><i class="fa fa-database proicon"></i><?php echo $lang['gold']; ?></div>
				<div class="bcell_mid prodata"><?php echo $user['user_gold']; ?></div>
			</div>
			<?php } ?>
		</div>
	</div>
	<div class="modal_zone hide_zone pad25" id="proabout">
		<div class="listing_element info_item">
			<div class="sub_text tbreak"><?php echo boomFormat($about);?></div>
		</div>
	</div>
