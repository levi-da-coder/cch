		...
		<div class="bcell_bottom profile_top">
			<div class="btable_auto">
				...
				<div class="profile_tinfo">
					<div class="pdetails">
						<div id="pro_name" class="globname pdetails_text pro_name cover_text">
							<?php echo $data['user_name']; ?>
						</div>
					</div>
					<?php if(useLike()){ ?>
					<div id="profile_like" class="pdetails">
...
<div id="meditprofile">
	<div class="modal_zone pad25 tpad15" id="personal_account">
		<div onclick="changeInfo();" class="btable blisting proitem">
			<div class="bcell_mid"><i class="fa fa-address-book-o proicon"></i><?php echo $lang['edit_info']; ?></div>
		</div>
		<?php if(canAbout()){ ?>
	...
	<div class="modal_zone hide_zone pad25 tpad15" id="personal_more">
		...
		<div onclick="getPrivateSettings();" class="btable blisting proitem">
			<div class="bcell_mid"><i class="fa fa-comments proicon"></i><?php echo $lang['private_settings']; ?></div>
		</div>
		<div onclick="changeShared();" class="btable blisting proitem">
			<div class="bcell_mid"><i class="fa fa-user-secret proicon"></i><?php echo $lang['edit_privacy']; ?></div>
		</div>
		...
		<div onclick="getUserLogin();" class="btable blisting proitem">
			<div class="bcell_mid"><i class="fa fa-lock proicon"></i><?php echo $lang['login_option']; ?></div>
		</div>
		<?php } ?>
		<?php if(isMember($data) && isSecure($data)){ ?>
		...
		<div id="del_account_btn" onclick="getDeleteAccount();" class="btable blisting proitem">
			<div class="bcell_mid"><i class="fa fa-trash proicon"></i><?php echo $lang['close_account']; ?></div>
		</div>
		<?php } ?>
	</div>
	<?php if(useGift()){ ?>
	<div class="modal_zone hide_zone pad25 tpad15" id="proselfgift" value="0">
		<div class="menu_spinner_wrap"><i class="fa fa-circle-o-notch fa-spin fa-fw bspin menu_spinner"></i></div>
	</div>
	<?php } ?>
</div>