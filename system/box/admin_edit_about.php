...
<div class="modal_content">
	<div class="setting_element">
		...
		<textarea id="admin_user_about" class="large_textarea about_area full_textarea" spellcheck="false" maxlength="800" ><?php echo userDataDetails($user, 'user_about'); ?></textarea>
	</div>
</div>
