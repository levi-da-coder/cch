...
<div class="modal_content">
	<div class="tpad15">
		<textarea id="set_user_note" class="xlarge_textarea about_area full_textarea" spellcheck="false" maxlength="10000" ><?php echo userDataDetails($user, 'user_note'); ?></textarea>
	</div>
</div>
