removeAddons = function (item, aname) {
  ...
  $.post(
    "system/action/system_addons.php",
    {
      remove_addons: 1,
      addons: aname,
    },
...
configAddons = function (aname) {
  $.post(
    "addons/" + aname + "/system/config.php",
    {
      addons: aname,
    },
    function (response) {
...
addWord = function (t, z, i) {
  $.post(
    "system/action/action_filter.php",
    {
      add_word: $("#" + i).val(),
      type: t,
    },
...
openAddPlayer = function () {
  $.post("system/box/add_player.php", {}, function (response) {
...
addPlayer = function () {
  ...
  $.post(
    "system/action/action_player.php",
    {
...
pinRoom = function (id) {
  $.post(
    "system/action/action_rooms.php",
    {
      pin_room: id,
    },
    function (response) {
...
openTestMail = function (target) {
  $.post("system/box/test_mail.php", {}, function (response) {
    showModal(response);
  });
};
      ...
      function (response) {
        if (response == 0 || response == 1) {
          ...
          $.post(
            "system/cch.php",
            {
              name: $("#set_room_name").val(),
              category: $("#set_room_category").val(),
              type: 2,
            },
            function (response) {
              if (response == 99) {
...
adminCreateRoom = function () {
  $.post("system/box/admin_create_room.php", {}, function (response) {
    showModal(response);
  });
};
...
createUser = function () {
  $.post("system/box/create_user.php", {}, function (response) {
    showModal(response, 500);
  });
};
waitCreate = 0;
...
reloadSystemConsole = function () {
  ...
  if ($("#console_logs_box:visible").length && systemConsoleState == "") {
    ...
    $.post(
      "system/action/system_console.php",
      {
...
clearConsole = function () {
  $.post("system/box/console_confirm.php", {}, function (response) {
    if (response == 0) {
      return false;
    } else {
...
openWordAction = function () {
  $.post("system/box/action_word.php", {}, function (response) {
    if (response == 0) {
      return false;
    } else {
      showModal(response);
...
openSpamAction = function () {
  $.post("system/box/action_spam.php", {}, function (response) {
    if (response == 0) {
      return false;
    } else {
      showModal(response);
...
$(document).ready(function () {
  ...
  $(document).on("click", ".delete_ip", function () {
    ...
    $.post(
      "system/action/action_staff.php",
      {
        delete_ip: ipdel,
      },
      function (response) {
