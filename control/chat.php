...
<div id="chat_head" class="bhead chat_head ">
    ...
    <div value="0" onclick="getPrivate();" id="get_private"
        class="privelem head_option menutrig <?php echo privCheck(); ?>">
        <div class="btable notif_zone">
            <div class="bcell_mid">
    ...
    <div data-menu="chat_main_menu" id="main_mob_menu" class="show_menu menutrig">
        ...
        <img class="top_status status_icon"
            src="default_images/status/<?php echo statusIcon($data['user_status']); ?>" />
    </div>
</div>
...
<div id="global_chat" class="backglob chatheight">
                    ...
                    <div id="container_show_chat">
                        ...
                        <div value="0" id="main_emoticon" class="back_box bshadow">
                            <div class="emo_head bborder main_emo_head">
                                <?php if(canEmo()){ ?>
                                <div data="base_emo" class="bselected emo_menu emo_menu_item"><img class="emo_select"
                                        src="emoticon_icon/base_emo.png" /></div>
                                <?php echo emoItem(1); ?>
                                <?php } ?>
                                <div class="empty_emo">
                                </div>
                            ...
                            <div class="uprogress_wrap">
                                ...
                                <div class="uprogress_content btable">
                                    <div class="bcell_mid uprogress_text">
                                        <p class="bold text_small"><i class="fa fa-upload"></i>
                                            <?php echo $lang['upload']; ?></p>
                                    </div>
                    ...
                    <div id="container_input" class="no_rtl hidden">
                        <form id="main_input" name="chat_data" action="" method="post">
                            <div class="input_table">
                                <div id="ok_sub_item" class="input_item main_item base_main sub_hidden"
                                    onclick="getChatSub();">
                                    <i class="fa fa-plus input_icon bblock"></i>
                                </div>
                                <div value="0" class="input_item main_item base_main" onclick="showEmoticon();"
                                    id="emo_item">
                                    <i class="fa fa-smile-o bblock"></i>
                                </div>
                                <div id="main_input_box" class="td_input">
                                    <input data-paste="<?php echo mainPaste(); ?>" type="text" spellcheck="false"
                                        name="content" placeholder="<?php echo $lang['type_something']; ?>"
                                        maxlength="<?php echo $setting['max_main']; ?>" id="content"
                                        autocomplete="off" />
                                </div>
                                <div id="inputt_right" class="main_item">
                                    <button type="submit" class="send_btn" id="submit_button"><i
            ...
            <div id="private_wrap_content" class="pcontent">
                ...
                <div id="private_emoticon" class="back_box bshadow">
                    <div class="emo_head bborder private_emo_head">
                        <?php if(canEmo()){ ?>
                        <div data="base_emo" class="bselected emo_menu emo_menu_item_priv"><img class="emo_select"
                                src="emoticon_icon/base_emo.png" /></div>
                        <?php echo emoItem(2); ?>
                        <?php } ?>
                        <div class="empty_emo">
                ...
                <div id="private_progress" class="uprogress">
                    <div class="uprogress_wrap">
                        ...
                        <div class="uprogress_content btable">
                            <div class="bcell_mid uprogress_text">
                                <p class="bold text_small"><i class="fa fa-upload"></i> <?php echo $lang['upload']; ?>
                                </p>
                            </div>
                    ...
                    <form id="message_form" action="" method="post" name="private_form">
                        <div class="input_table">
                            ...
                            <div value="0" id="emo_item_priv" class="input_item main_item"
                                onclick="showPrivEmoticon();">
                                <i class="fa fa-smile-o"></i>
                            </div>
                            <div id="private_input_box" class="td_input">
                                <input data-paste="<?php echo privatePaste(); ?>" spellcheck="false"
                                    id="message_content" placeholder="<?php echo $lang['type_something']; ?>"
                                    maxlength="<?php echo $setting['max_private']; ?>" autocomplete="off" />
                            </div>
    ...
    <div id="chat_right" class="cright back_panel lborder bshadow pheight">
        <div id="right_panel_bar" class="bborder panel_bar">
            ...
            <div id="users_option" title="<?php echo $lang['user_list']; ?>" class="bselected panel_option"
                onclick="userReload(1);">
                <i class="fa fa-users"></i>
            </div>
            <?php if(boomAllow(1)){ ?>
            <div id="friends_option" title="<?php echo $lang['friend_list']; ?>" class="panel_option"
                onclick="myFriends(1);">
                <i class="fa fa-user"></i>
            </div>
            <?php } ?>
            <div id="search_option" title="<?php echo $lang['search_user']; ?>" class="panel_option"
...
<div id="chat_main_menu" class="sysmenu back_menu float_menu">
    <div class="float_ctop" id="mmenu_top">
        <div class="btable pad10">
            ...
            <div data-menu="status_menu" class="bcell_mid editstatus show_menu">
                <img class="stat_icon status_icon"
                    src="default_images/status/<?php echo statusIcon($data['user_status']); ?>" />
            </div>
        </div>
    </div>
    <div class="float_content">
        ...
        ?>
            <div class="fmenu_item bhover mmenu_item" onclick="getListToInvite();">
                <div class="fmenu_icon">
                    <i class="fa fa-plus menui"></i>
                </div>
                <div class="fmenu_text">
                    <?php echo "Invite Friends"; ?>
                </div>
            </div>
            <?php } ?>
            <?php if(useLobby()){ ?>
