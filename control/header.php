...
<div id="header_full" class="bhead">
    ...
    <?php if($data['user_roomid'] == "0") { ?>
    <div class="lobby__navbar">
        <div>
            <li id="filterAll" onclick="applyLobbyFilter('all')">All</li>
            <li id="filterPopular" onclick="applyLobbyFilter('popular')">Popular</li>
            <li id="filterCountry" onclick="applyLobbyFilter('country')">Country</li>
            <li id="filterDating" onclick="applyLobbyFilter('dating')">Dating</li>
            <li id="filterFriendship" onclick="applyLobbyFilter('friendship')">Friendship</li>
        </div>
    </div>
    <?php } ?>
</div>
